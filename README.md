...
you must first install lovely injector (https://github.com/ethangreen-dev/lovely-injector) and steammodded (https://github.com/Steamodded/smods) in order to use 
